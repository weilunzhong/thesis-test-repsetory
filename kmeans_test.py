...
# tomorrow try to replace this with self generated data and possiblly mluti-dimensional data
# also try to work with sift features 


# Plot the data, K-means clustering, plot again
